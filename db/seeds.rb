...
console_data = [
  { name: "PS5", brand: "PlayStation", user: guillaume, price: "4€", adress:"19 rue de la barre 59800 Lille", image: "https://assets-prd.ignimgs.com/2020/06/12/playstation-5-button-02-1591933908407.jpg", content: "La PlayStation 5 (PS5) est une console de jeu de nouvelle génération développée par Sony. Elle offre des performances de pointe, une immersion visuelle exceptionnelle grâce à sa puissance graphique, et une expérience de jeu immersive grâce à sa technologie innovante."},
